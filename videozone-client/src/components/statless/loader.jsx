...
export const LoaderSVG = (({className, classNameSVG}) => {
  return(
    <span className={`${className} svg-icon`}>
     <svg className={`${classNameSVG} svg-icon-svg`} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{enableBackground: 'new 0 0 512 512'}} xmlSpace="preserve">
        <g>
          <g>
